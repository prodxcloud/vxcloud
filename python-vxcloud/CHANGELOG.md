...
- Re-pinned to `vxsdk==2026.8.28` (base + `[async]` extra).
- Contact address is now `joelwembo@outlook.com`; `engineering@vxcloud.io` was
  not a monitored mailbox. No code changes.
