...
>
> **Current release: `2026.8.26`.** Go resolves it as `v0.20260826.0` — see
...
go get github.com/prodxcloud/vxcloud@v0.20260826.0
```

> **Why the Go tag reads `v0.20260826.0` and not `2026.8.26`** — they are the
> same release. Go requires module versions to be semver, and it parses a
> `v`-prefixed CalVer tag as a *major version*: `v2026.8.26` means major 2026,
> which it rejects unless the module path ends in `/v2026`. So the date is
> carried in the **minor** field instead, as `YYYYMMDD`:
>
> | Release | Go tag |
> |---|---|
> | `2026.8.26` | `v0.20260826.0` |
> | `2026.12.25` | `v0.20261225.0` |
> | same-day hotfix | `v0.20260826.1` |
>
...
>
> `@2026.8.26` and `@v2026.8.26` will **not** resolve, and `v0.2.0` is retracted.
...
| **Versioning** | CalVer `YYYY.M.D` (currently `2026.8.26`); the Go module tag encodes the same date as `v0.20260826.0`. v1.0 will guarantee stability across minor releases. |
